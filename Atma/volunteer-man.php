...
<body>
<form action = "volunteer-man.php" action = "POST">
<input type = "text" name = "volunteer"/>

<input type = "submit" value="Get volunteer details">
</form>
<?php 
$user = $_SESSION['login_user'];
$vol = $_POST['volunteer'];
$user = stripslashes($user);
$sql = "SELECT * FROM `volunteer_manager_profile` where `username` LIKE '$user'";
