        ...
        <div class="row" id="SP">
              ...
              <?php 
                ...
                while($row = mysql_fetch_assoc($result)) {
                  ...
                  $res = $result = mysql_query($inner_sql, $conn);
                  $s_index = 0;
              ...
              ?>
				...
				<div class="col-sm-6">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title text-center">AIP</h3>
						</div>
						...
						<table class="table table-bordered">
							...
							<form action="/team-15/Atma/pages/tables/quarterly.php" method="GET">
							  <tr>
								...
								<td><input type="submit" class="btn btn-large btn-danger" name="Quarterly" value="Quarterly 1 (2)"/></td>
								<td><input type="submit" class="btn btn-large btn-success" name="Quarterly" value="Quarterly 1 (3)"/></td>
							  </tr>
							  <tr>
								<td><input type="submit" class="btn btn-large btn-primary" name="Quarterly" value="Quarterly 2 (1)"/></td>
								<td><input type="submit" class="btn btn-large btn-danger" name="Quarterly" value="Quarterly 2 (2)"/></td>
								<td><input type="submit" class="btn btn-large btn-success" name="Quarterly" value="Quarterly 2 (3)"/></td>	
								</tr>
							  <tr>
								<td><input type="submit" class="btn btn-large btn-primary" name="Quarterly" value="Quarterly 3 (1)"/></td>
								<td><input type="submit" class="btn btn-large btn-danger" name="Quarterly" value="Quarterly 3 (2)"/></td>
								<td><input type="submit" class="btn btn-large btn-success" name="Quarterly" value="Quarterly 3 (3)"/></td>
							  </tr>
							  
							  <tr>
								<td><input type="submit" class="btn btn-large btn-primary" name="Quarterly" value="Quarterly 4 (1)"/></td>
								<td><input type="submit" class="btn btn-large btn-danger" name="Quarterly" value="Quarterly 4 (2)"/></td>
								<td><input type="submit" class="btn btn-large btn-success" name="Quarterly" value="Quarterly 4 (3)"/></td>
							  </tr>
							</form>
							</tbody>
						  </table>
            ...
            <div class="box-footer text-black">
              <div class="row">
                <div class="col-sm-6">
                  ...
                  <div class="clearfix">
                    <span class="pull-left active">Task #2</span>
