                                ...
                                <div class="box-body table-responsive no-padding">
                                    <table class="table table-hover">
                                        ...
                                        <?php
                                            ...
                                            $which=$_GET["Quarterly"];
                                            $aip=0;
											$q=0;
                                            if($which=="Quarterly 1 (1)")
                                            {
                                            $aip=1;
                                            $q=1;
                                            }
                                            else if($which=="Quarterly 1 (2)")
                                            {
                                            $aip=2;
                                            $q=1;
                                            }
                                            else if($which=="Quarterly 1 (3)")
                                            {
                                            $aip=3;
                                            $q=1;
                                            }
                                            else if($which=="Quarterly 2 (1)")
                                            {
                                            $aip=1;
                                            $q=2;
                                            }
                                            else if($which=="Quarterly 2 (2)")
                                            {
                                            $aip=2;
                                            $q=2;
                                            }
                                            else if($which=="Quarterly 2 (3)")
                                            {
                                            $aip=3;
                                            $q=2;
                                            }
                                            else if($which=="Quarterly 3 (1)")
                                            {
                                            $aip=1;
                                            $q=3;
                                            }
                                            else if($which=="Quarterly 3 (2)")
                                            {
                                            $aip=2;
                                            $q=3;
                                            }else if($which=="Quarterly 3 (3)")
                                            {
                                            $aip=3;
                                            $q=3;
                                            }
                                            else if($which=="Quarterly 4 (1)")
                                            {
                                            $aip=1;
                                            $q=4;
                                            }
                                            else if($which=="Quarterly 4 (2)")
                                            {
                                            $aip=2;
                                            $q=4;
                                            }
                                            else if($which=="Quarterly 4 (3)")
                                            {
                                            $aip=3;
                                            $q=4;
                                            }
...
=======
                ...
                <!-- /.content -->
>>>>>>> 0e0a58f7ce4eeb5451834e268ea2f05ed6c231d8
            </div>
            <!-- /.content-wrapper -->
...
<<<<<<< HEAD
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2014-2016 <a href="http://almsaeedstudio.com">ATMA</a>.</strong> All rights
    reserved.
  </footer>
